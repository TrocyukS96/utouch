...
export const Promo: FC<IPromo> = (className) => {
    const finalClassName = className ? `${s.promo} ${className}` : `${s.promo}`

    return (
        <div className={finalClassName}>
            <div className={s.bgPhone1}></div>
            <div className={s.bgPhone2}></div>
            <h3 className={s.promoTitle}>Хотите стать частью нашей команды?</h3>
            <p className={s.promoText}>Напишите нам в социальных сетях и мы ответим в течение 24 часов!</p>
            <div className={s.social}>
                ...
                >
                    <div className={s.linkInner}>
                        ...
                        <span className={s.linkText}>Перейти в
                                        группу ВКонтакте</span>
                    </div>
                </a>
                <a href={media.tgPublic} className={s.socialLink} rel={'noreferrer'} target={'_blank'}>
                    <div className={s.linkInner}>
                        ...
                        <span className={s.linkText}>Написать в
                                        Telegram</span>
                    </div>
                </a>
            </div>
